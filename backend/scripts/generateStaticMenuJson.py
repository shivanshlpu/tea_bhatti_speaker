...
out_path = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', '..', 'frontend', 'data', 'menu.json'))
...
print(f"Generated static menu.json with {len(categories)} categories and {len(items)} items")
